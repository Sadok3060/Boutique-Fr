...
class getListUsersCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['App\\Command\\ListUsersCommand'] = $instance = new \App\Command\ListUsersCommand(($container->services['doctrine.orm.default_entity_manager'] ?? $container->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->setName('app:list-users');
        $instance->setDescription('Liste tous les utilisateurs de la base de données');
