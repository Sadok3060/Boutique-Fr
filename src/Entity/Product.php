...
class Product
{
    ...
    public function getMainImageUrl(): ?string
    {
        ...
        // If the value already looks like a path (starts with '/') or a full URL, return it as-is
        if (str_starts_with($this->mainImage, '/') || filter_var($this->mainImage, FILTER_VALIDATE_URL)) {
            return $this->mainImage;
        }
    ...
    public function getImagesUrls(): array
    {
        ...
        foreach ($this->images as $image) {
            // If the stored image is already a path or an URL, keep it as-is
            if (str_starts_with($image, '/') || filter_var($image, FILTER_VALIDATE_URL)) {
                $urls[] = $image;
            } else {
