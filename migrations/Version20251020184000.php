...
final class Version20251020184000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add any missing columns for product, category, user, order and order_item tables (idempotent)';
    }
...
BEGIN
    ...
    END IF;
    -- add user_id FK column if missing
    ...
    END IF;
    -- create unique index on order_number if missing
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE tablename = 'order' AND indexname = 'uniq_order_order_number') THEN
        CREATE UNIQUE INDEX uniq_order_order_number ON "order"(order_number);
    END IF;
END$$;
SQL
        );
...
SQL
    ...
    {
        // Remove columns if exist (safe)
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS stock");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS main_image");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS images");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS sku");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS is_active");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS is_featured");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS created_at");
        $this->addSql("ALTER TABLE product DROP COLUMN IF EXISTS updated_at");

        $this->addSql("ALTER TABLE category DROP COLUMN IF EXISTS image");
        $this->addSql("ALTER TABLE category DROP COLUMN IF EXISTS is_active");
        $this->addSql("ALTER TABLE category DROP COLUMN IF EXISTS created_at");
        $this->addSql("ALTER TABLE category DROP COLUMN IF EXISTS updated_at");
        ...
        $this->addSql("ALTER TABLE \"user\" DROP COLUMN IF EXISTS address");
        $this->addSql("ALTER TABLE \"user\" DROP COLUMN IF EXISTS postal_code");
        $this->addSql("ALTER TABLE \"user\" DROP COLUMN IF EXISTS city");
        $this->addSql("ALTER TABLE \"user\" DROP COLUMN IF EXISTS country");
        ...
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS order_number");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS status");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS subtotal");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS tva");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS total");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS shipping_address");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS shipping_postal_code");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS shipping_city");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS shipping_country");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS shipping_phone");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS notes");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS created_at");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS updated_at");
        $this->addSql("ALTER TABLE \"order\" DROP COLUMN IF EXISTS user_id");
        $this->addSql("DROP INDEX IF EXISTS uniq_order_order_number");

        $this->addSql("ALTER TABLE order_item DROP COLUMN IF EXISTS quantity");
        $this->addSql("ALTER TABLE order_item DROP COLUMN IF EXISTS unit_price");
        $this->addSql("ALTER TABLE order_item DROP COLUMN IF EXISTS subtotal");
        $this->addSql("ALTER TABLE order_item DROP COLUMN IF EXISTS order_id");
        $this->addSql("ALTER TABLE order_item DROP COLUMN IF EXISTS product_id");
    }
}
